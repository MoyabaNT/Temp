        ...
        <div name="firstCard" className="w-full sm:w-3/4 md:w-1/2 lg:w-1/3 flex flex-col justify-center items-center p-8 border-r-1 border-amber-100">
          <div className="bg-amber-100 rounded-lg w-full p-6 sm:p-8 text-left">
            <form name="formo" onSubmit={vali} method="post">
              <h1 className="text-center text-amber-700 font-bold text-2xl sm:text-3xl"> Create an account</h1>
              ...
              <div className="p-2">
                <label className="text-amber-700 mb-1 p-2 text-lg">Name</label>
                <input
                  type="text"
                  name="fName"
                  value={fname}
              ...
              <div className="p-2">
                <label className="text-amber-700 mb-1 p-2 text-lg">Surname</label>
                <input
                  type="text"
                  name="fName"
                  value={lname}
            ...
            <div className="flex p-2 justify-center sm:justify-start mt-4">
              ...
              <button onClick={() => navigate("/LogIn")} className="ml-2 text-amber-800 font-bold">
                Log In
              </button>
          </div>
          </div>
